...
$form['form-1'] = array(
	...
	'cfg' => array(
		...
		'okay' => '<div class="result_heading">Спасибо <br> за Вашу заявку!</div>
<div class="result_content">Мы перезвоним Вам<br> в течение 10 минут</div>',
		'fuck' => '<div class="result_heading">Спасибо <br> за Вашу заявку!</div>
<div class="result_content">Мы перезвоним Вам<br> в течение 10 минут</div>',
		'spam' => 'Cпам робот',
...
$form['form-2'] = array(
    ...
    'cfg' => array(
        ...
        'antispam' => 'email77',
        'antispamjs' => 'address77',
        'okay' => '<div class="result_heading">Спасибо <br> за Ваш вопрос!</div>
<div class="result_content">Мы ответим Вам<br> в течение 24 часов</div>',
        'fuck' => '<div class="result_heading">Спасибо <br> за Ваш вопрос!</div>
<div class="result_content">Мы ответим Вам<br> в течение 24 часов</div>',
        'spam' => 'Cпам робот',
        'notify' => 'color-modal-textbox',
        'usepresuf' => false
...
$form['form-3'] = array(
    ...
    'cfg' => array(
        ...
        'antispam' => 'email77',
        'antispamjs' => 'address77',
        'okay' => '<div class="result_heading">Спасибо <br> за Ваш заказ!</div>
<div class="result_content">Мы сделаем вариант<br>Вашего макета в течение<br>24 часов!</div>',
        'fuck' => '<div class="result_heading">Спасибо <br> за Ваш заказ!</div>
<div class="result_content">Мы сделаем вариант<br>Вашего макета в течение<br>24 часов!</div>',
        'spam' => 'Cпам робот',
        'notify' => 'color-modal-textbox',
        'usepresuf' => false,
   ...
   $sb = array(); // subject и body
    ...
    if(count($error) == 0) {
      ...
      $sb['subject'] = (function_exists("mb_encode_mimeheader")) ? mb_encode_mimeheader($form['cfg']['subject'], $form['cfg']['charset'], "Q") : $form['cfg']['subject'];
        //$sb['subject'] = (function_exists("mb_encode_mimeheader")) ? mb_encode_mimeheader($form['fields']['source'], $form['cfg']['charset'], "Q") : $form['fields']['source'];
      ...
      $headers .= "Content-Type: " . $form['cfg']['type'] . "; charset=\"" . $form['cfg']['charset'] . "\"\r\n";
