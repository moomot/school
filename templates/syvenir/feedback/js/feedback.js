        ...
        success: function(answer) {
          ...
          if(isset(cfg.notify) && !/none/i.test(cfg.notify)) {
             ...
             if(/textbox/i.test(cfg.notify)) {
                 ...
                 //$(vars.form).find('input[type=text]:visible, textarea:visible, select:visible').css({'border': '12px solid #f4bf04'}, 300);
                 if(isset(answer.errors)) {
                     $.each(answer.errors, function(k,val) {
                         var reg = /[a-z]/i;
                         if(reg.test(k)) {
                          ...
                          if(e.length == 1) {
                           //$(e).css({'border': '12px solid red'}, 100);
                          }
                        }
                     });
                 } if(isset(answer.infos)) {
...
$(document).on('submit', '.arctic-form', function(){
   var form = $(this).closest('form'),
       name = form.attr('name'), obj = {};
       obj.form = form;
       obj.act = name;
